...
parser.add_argument('--train_path', help='Path to train dataset.', default='/content/working_dir/train')
parser.add_argument('--val_path', help='Path to validation dataset', default='/content/working_dir/val')
parser.add_argument('--anchors_path', help='Path to anchor file', default='/content/working_dir/model_data/yolo_anchors.txt')
parser.add_argument('--classes_path', help='Path to class file', default='/content/working_dir/model_data/voc_classes.txt')
parser.add_argument('--model_path', help='Path to pretrained weights, filename ending in .h5', default='/content/working_dir/model_data/yolo.h5')
...
def _main(args):
    ...
    log_dir = '/content/working_dir/logs/'+str(backbone).split('.')[1].lower()+str(datetime.date.today())
    batch_size = 4

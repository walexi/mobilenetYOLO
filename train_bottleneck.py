...
def _main():
    ...
    log_dir = '/content/working_dir/logs/000/'
    classes_path = '/content/working_dir/model_data/coco_classes.txt'
    ...
    model, bottleneck_model, last_layer_model = create_model(input_shape, anchors, num_classes,
            freeze_body=2, weights_path='/content/working_dir/model_data/yolov3.weights') # make sure you know what you freeze
